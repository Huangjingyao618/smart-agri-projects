...
> YOLOv11 目标检测 + PyQt5 桌面 GUI · 识别 5 种常见野菜 · 端到端的 AI 应用开发

---

## 📋 项目简介

基于 YOLOv11n 深度学习模型训练，识别 **5 种常见野菜** 的图像分类系统。提供 PyQt5 桌面 GUI 应用，用户上传图片即可一键识别野菜种类。实现了从**数据准备 → 模型训练 → 推理预测 → GUI 应用**的完整 AI 应用开发流程。
...
- 基于 PyQt5 开发桌面 GUI 应用，完成 AI 模型的桌面应用封装
